          ...
          products.slice(1,4).map((item,index) => (
            <div key={index} className='py-4 border-t border-b text-gray-700 flex flex-col md:flex-row md:item-center md:justify-between gap-4'>
                ...
                <div className="md:w-1/2 flex justify-between items-center">
                  ...
                  <button className="border border-gray-300 px-4 py-2 text-sm font-medium rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">Track Order</button>
                </div>
            </div>
          ))
        }
